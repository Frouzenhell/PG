...
void DemoProj::initModels()
{
	...
	m = objL.loadModel(getResFile("moucha/tree.obj"));
	m_sceneData->models.push_back(m);

	resetResPath();
}

void DemoProj::initVAOs()
{
...
void DemoProj::initInfoEntities()
{
...
void DemoProj::initSceneEntities()
{
